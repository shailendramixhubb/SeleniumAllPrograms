...
public class EmailSendMultiple {
    ...
    //	logger.info("Enter Email");
		...
		if(driver.findElement(By.xpath("//div[@class='col-md-12']//div[1]//div[2]//div[1]//div[1]//div[2]//a[1]")).isDisplayed()){     
			...
			WebElement ele=driver.findElement(By.xpath("//tbody/tr[4]/td[5]/div[2]/span[1]/button[1]/span[1]//*[name()='svg']//*[name()='g' and @id='push_icon']//*[name()='g' and @id='noun-button-click-691746']"));
			ele.click();
			Thread.sleep(5000);
	        }
